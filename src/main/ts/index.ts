...
const FLAG_ANGLE_BULLETS = false || FLAG_ALL_ON;
...
const SHOOT_VELOCITY = FLAG_CHANGE_FONT?-.1:-.1;
...
const JUMP_VELOCITY = FLAG_CHANGE_FONT?-.6:FLAG_EMOJI_CHARACTERS?-.2:-.2;
